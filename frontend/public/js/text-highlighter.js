(function (global) {
     ...
     * @memberof TextHighlighter
     */
    TextHighlighter.prototype.doHighlight = function (keepRange, range, flag = true,flag2 = true) {
        var wrapper,
            createdHighlights,
        ...
        if (this.options.onBeforeHighlight(range,flag) === true) {
            ...
            this.options.onAfterHighlight(range, normalizedHighlights, timestamp ,flag,flag2);
        }
    ...
    // just for bb-table
    TextHighlighter.prototype.highlightCustomRange = function (startEl, endEl ,flag,flag2) {
        var wnd = dom(this.el).getWindow(),
            scrollX = wnd.scrollX,
            scrollY = wnd.scrollY;
