...
const localeInfo = {
  'en-US': {
    messages: {
      ...require('/Users/hk/dev/pmXRisk/op_fe/src/locales/en-US.js').default,
    },
    locale: 'en-US',
  ...
  'pt-BR': {
    messages: {
      ...require('/Users/hk/dev/pmXRisk/op_fe/src/locales/pt-BR.js').default,
    },
    locale: 'pt-BR',
  ...
  'zh-CN': {
    messages: {
      ...require('/Users/hk/dev/pmXRisk/op_fe/src/locales/zh-CN.js').default,
    },
    locale: 'zh-CN',
  ...
  'zh-TW': {
    messages: {
      ...require('/Users/hk/dev/pmXRisk/op_fe/src/locales/zh-TW.js').default,
    },
    locale: 'zh-TW',
